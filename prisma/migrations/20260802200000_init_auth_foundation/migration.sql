...
-- CreateEnum
CREATE TYPE "OrderClaimStatus" AS ENUM ('UNCLAIMED', 'CLAIMED');
...
CREATE TABLE "Order" (
    ...
    "providerCurrency" TEXT DEFAULT 'USD',
    "displayAmount" DECIMAL(12,2),
    "displayCurrency" TEXT,
    "status" "OrderStatus" NOT NULL DEFAULT 'COMPLETED',
    "iccidEncrypted" TEXT,
    "claimStatus" "OrderClaimStatus" NOT NULL DEFAULT 'UNCLAIMED',
