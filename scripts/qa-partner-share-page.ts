...
async function main() {
  ...
  assert.match(pageSrc, /flex flex-col items-center text-center/);
  ...
  assert.match(logoCmp, /max-w-\[160px\]/);
  assert.match(logoCmp, /sm:max-w-\[180px\]/);
  assert.match(logoCmp, /max-h-14/);
  assert.match(logoCmp, /sm:max-h-16/);
