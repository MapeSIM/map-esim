 ...
 * Homepage is always `https://mapesim.com` (no trailing slash) to match
 * sitemap.ts and live HTML. Other public paths are origin + path with no
 * trailing slash.
 */
