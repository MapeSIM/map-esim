...
function CountriesListingContent({
  initialDestinations,
  initialSource,
  ...
  const [destinations, setDestinations] = useState<DestinationCard[]>(() =>
    initialDestinations.map(toCard)
  );
...
export default function CountriesListing(props: CountriesListingProps) {
  return (
    <Suspense
      fallback={
