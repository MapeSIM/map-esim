...
import { getAdminReconciliationWalletPurchase } from "@/app/lib/esim/adminWalletPurchaseRead";
...
export default async function AdminCustomerWalletBuyReviewNeededPage({
  params,
  searchParams,
}: {
  ...
  const purchase = await getAdminReconciliationWalletPurchase(
    admin.id,
    id,
    purchaseId
  );
    ...
    <div className="mx-auto max-w-xl space-y-8">
      <div>
        ...
        <p className="mt-2 text-sm text-[var(--text-muted)]">
          The provider result is uncertain or local finalization failed. Funds
          remain reserved. Do not retry this purchase automatically.
        </p>
      </div>
