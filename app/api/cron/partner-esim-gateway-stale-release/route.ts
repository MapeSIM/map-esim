/**
 * Secured HTTP trigger for Partner eSIM gateway stale/expired reservation release.
 ...
 * lifecycle already owns that slot). Hit from an approved external scheduler
 * or after a plan upgrade adds another cron entry.
 *
...
/** Small DB scan + per-row release transactions. */
